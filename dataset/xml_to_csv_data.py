...
train_image_path = os.path.join(os.getcwd(), 'image/train')   #训练集的路径
train_save_csv=os.path.join(os.getcwd(), 'image','train.csv')#保存csv文件的路径

#test数据的目录
test_image_path = os.path.join(os.getcwd(), 'image/test')    #测试集的路径
test_save_csv=os.path.join(os.getcwd(), 'image','test.csv')  #保存csv文件的路径
